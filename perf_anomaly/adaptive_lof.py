...
class WindowAdaptiveLOF(object):
    def __init__(self, window_size: int):
        ...
        self._X_sclaed = None  # type: np.ndarray
    ...
    def fit(self, X: np.ndarray):
        self._X = X
        self._X_sclaed = self._scaler.fit_transform(X)
        self._lof.fit(X)
    ...
    def add_new_data_point(self, x):
        ...
        self._X_sclaed = self._scaler.fit_transform(self._X)
        self._lof.fit(self._X_sclaed)
